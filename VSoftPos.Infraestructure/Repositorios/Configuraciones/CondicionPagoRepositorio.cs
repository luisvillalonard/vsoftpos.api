...
{
    public class CondicionPagoRepositorio : RepositorioGenerico<CondicionPago, int>, ICondicionPagoRepositorio
    {
        public CondicionPagoRepositorio(PosContext context) : base(context) { }
    }
}
